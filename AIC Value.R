...
glm(Churn~ tenure+StreamingTV+MonthlyCharges+TotalCharges, data = train, family = "binomial")->log_mod2
summary(log_mod2)
...
glm(DrugID~Gender+Age+PatientID, data = train, family = "binomial")->log_mod3
summary(log_mod3)
